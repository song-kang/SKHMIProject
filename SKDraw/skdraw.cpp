...
void SKDraw::InitBaseItem()
{
	...
	item = new QListWidgetItem(QIcon(":/images/arcCircle"),tr("圆弧线"));
	item->setData(Qt::UserRole,eDrawArcCircle);
	item->setToolTip(tr("圆弧线"));
	ui.listWidgetBase->addItem(item);

	item = new QListWidgetItem(QIcon(":/images/arcEllipse"),tr("椭圆弧线"));
	item->setData(Qt::UserRole,eDrawArcEllipse);
	item->setToolTip(tr("椭圆弧线"));
	ui.listWidgetBase->addItem(item);
