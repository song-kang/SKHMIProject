...
{
	return "plugin_modbus_rtu=ModbusRtu配置界面";
}
//////////////////////////////////////////////////////////////////////////
...
PLUGIN_EXPORT void* SSP_NewView(const char* sFunName,const void* parentWidget)
{
	...
	if(sName == "plugin_modbus_rtu")
		return new view_plugin_modbus_rtu((QWidget*)parentWidget);
